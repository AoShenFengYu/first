...
public class Crop {
    ...
    public static Crop of(String path, Uri destination) {
        return new Crop(path, destination);
    }
    ...
    private Crop(String path, Uri destination) {
        cropIntent = new Intent();
        cropIntent.putExtra(EXTRA_SELECTED_IMAGE_PATH, path);
        cropIntent.putExtra(MediaStore.EXTRA_OUTPUT, destination);
    }
