...
public class ActivateDialog2 extends Dialog implements View.OnClickListener{
    ...
    public ActivateDialog2(@NonNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.dialog_kika2, null);
...
//        TrackerCompat.getTracker().logEventRealTime("sticker_dialog2",item,String.valueOf(kikaState),extra);
    }
}
