package com.qisiemoji.apksticker.recyclerview.ptr.indicator;
...
public class PtrIndicator {
    ...
    public void updateRefreshHeight(int height) {
        mOffsetToRefresh = (int) (mRatioOfHeaderHeightToRefresh * height);
    }
